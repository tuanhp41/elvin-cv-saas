...
3. KHÔNG đổi stack mà không có DECISIONS.md entry
4. Luôn đọc ARCHITECTURE.md trước khi tạo file/folder
5. Luôn đọc CURRENT_STATE.md đầu mỗi session
6. Ghi CURRENT_STATE.md cuối mỗi session (overwrite)

## Mục tiêu cốt lõi
- Học AI Engineering — revenue là thứ yếu
- Mỗi feature build = 1 kỹ năng AI mới
- Document quyết định vào DECISIONS.md
...
→ Ghi vào DECISIONS.md nếu có quyết định quan trọng
